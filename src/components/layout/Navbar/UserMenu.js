...
function UserMenu() {
	...
	useEffect(() => {
		...
		verifyRoles();
	}, [twitchUser?.login, twitchToken, rolesToken, setRolesToken, twitchUser]);
	...
	useEffect(() => {
		...
		handleAuthCallback();
	}, [setTwitchUser, setTwitchToken, setRolesToken]);
